...
\\
\\
\uline{1. Fall} $a\geqslant 0$, $b > 0$ Trivial\\
\\
\\
\uline{2. Fall} $a\geqslant 0$, $b < 0$ Euklid $\mathbb{N}$ anwenden auf $(a, -b)$. Liefert\\
\\
$a = (-b)*q + r \wedge 0 \leqslant r < -b$\\
\\
Waehle $(q', r') = (-q, r)$  $-b = |b|$\\
...
\\
\\
\uline{3. Fall} $a< 0 \wedge b > 0 $ Euklid $\mathbb{N}$ anwenden auf $(-a,b)$ Liefert\\
\\
$-a = b*q + r \wedge 0 \leqslant r < b$\\
\\
\\
