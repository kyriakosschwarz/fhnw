...
Sei $n$ eine \uline{beliebige} natuerliche Zahl\\
\\
\uline{Annahme:} $(\sum{i} : \mathbb{N} \:\vert\: 1\leqslant i\leqslant n : fib(i)) = f(n+2) -1$\\
\\
\uline{zu zeigen:} $(\sum{i} : \mathbb{N} \:\vert\: 1\leqslant i\leqslant n+1: fib(i)) = f(n+3) -1$\\
\\
$(\sum{i} : \mathbb{N} \:\vert\: 1\leqslant i\leqslant n : fib(i))$\\
\\
