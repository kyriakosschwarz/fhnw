...
\rule{\textwidth}{0.4mm}\\
\\
Bsp: $(\sum{i} \:\vert\: 1\leqslant i< n : i^2 )$\\
\\
wobei $i: v$, $(1\leqslant i< n): R$, $i^2: P$\\
\\
$= (\sum{j} \:\vert\: (1\leqslant i< n)[i\leftarrow j] : i^2[i\leftarrow j] )$\\
\\
wobei $j: w$\\
\\
$= (\sum{j} \:\vert\: 1\leqslant j< n : j^2)$\\
\\
\\
\uline{Aber:} Vorsicht:\\
\\
$(\sum{i} : \:\vert\: 1\leqslant i< n : i^2 )$\\
$n=0 : 0(neutral +)$\\
$n=1 : 1$\\
\\
haengt von $n$ ab\\
...
$\neq$\\
\\
$(\sum{n} : \:\vert\: 1\leqslant n< n : n^2 )$\\
$\infty$ undefiniert\\
\\
haengt \uline{nicht} vom $n$ ab\\
\\
\\
\rule{\textwidth}{0.4mm}\\
\\
